        ...
        <div class="row">  
            ...
            <div class="col-sm-12 col-md-6 contact_right">
                ...
                <div class="col-md-12 contact_text">
                    Silahkan hubungi kami jika membutuhkan informasi lebih lengkap
                </div>
                
                <div class="col-md-12 contact_info">
                    <a href="mailto:info@company.com" class="contact-info-link">
                        <i class="fa fa-envelope contact-fa"></i>costumboss@gmail.com
                    </a><br/>
                    <a href="+0987654321" class="contact-info-link">
                        <i class="fa fa-phone contact-fa"></i>(+62) 82240203703 (Admin - Khairy)
                    </a><br/>
                </div>
