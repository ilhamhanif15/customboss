    ...
    <div class="row">
      <div class="col-md-12 col-lg-8">
        <div class="title-single-box">
          <h1 class="title-single">KONTAK</h1>
          <h4>INFORMASI</h4>
        </div>
      </div>
    </div>
            ...
            <div class="icon-box section-b2">
              ...
              <div class="icon-box-content table-cell">
                ...
                <div class="icon-box-content">
                  ...
                  <p class="mb-1">Phone :
                    <span class="color-a">(+62) 82240203703 (Admin - Khairy)</span>
                  </p>
                </div>
              </div>
            </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="card-box-d">
          <div class="card-img-d">
            <img src="<?= base_url().'assetsPC/' ?>img/suwaldi.jpg" alt="" class="img-d img-fluid">
          </div>
          <div class="card-overlay card-overlay-hover">
            <div class="card-header-d">
              <div class="card-title-d align-self-center">
                <h3 class="title-d">
                  <p class="link-two">Suwaldi 
                    <br> Mardana</p>
                </h3>
              </div>
            </div>
      ...
      <div class="col-md-4">
        <div class="card-box-d">
          <div class="card-img-d">
            <img src="<?= base_url().'assetsPC/' ?>img/faisal.jpg" alt="" class="img-d img-fluid">
          </div>
          <div class="card-overlay card-overlay-hover">
            <div class="card-header-d">
              <div class="card-title-d align-self-center">
                <h3 class="title-d">
                  <p class="link-two">Ananda Faisal
                    <br> Faritz</p>
                </h3>
              </div>
            </div>
      ...
      <div class="col-md-4">
        <div class="card-box-d">
          <div class="card-img-d">
            <img src="<?= base_url().'assetsPC/' ?>img/hanif.jpg" alt="" class="img-d img-fluid">
          </div>
          <div class="card-overlay card-overlay-hover">
            <div class="card-header-d">
              <div class="card-title-d align-self-center">
                <h3 class="title-d">
                  <p class="link-two">Ilham Hanif
                    <br> Anjana</p>
                </h3>
              </div>
            </div>
      ...
      <div class="col-md-4">
        <div class="card-box-d">
          <div class="card-img-d">
            <img src="<?= base_url().'assetsPC/' ?>img/sidik.jpg" alt="" class="img-d img-fluid">
          </div>
          <div class="card-overlay card-overlay-hover">
            <div class="card-header-d">
              <div class="card-title-d align-self-center">
                <h3 class="title-d">
                  <p class="link-two">Sidik
                    <br> Kurniawan</p>
                </h3>
              </div>
            </div>
